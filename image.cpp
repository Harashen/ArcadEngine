...
SDL_Surface *CImage::Load(const char *filename)
{
	/* Load image */
	return IMG_Load(filename);
}

SDL_Surface *CImage::Load(string filename)
{
...
bool CImage::Save(SDL_Surface *surface, const char *filename)
{
	string S(filename);
...
bool CImage::Save(SDL_Surface *surface, string filename)
{
	string ext;
	Uint32 pos;
...
bool CImage::SaveBMP(SDL_Surface *surface, const char *filename)
{
	/* Save surface */
	return !SDL_SaveBMP(surface, filename);
}

bool CImage::SaveBMP(SDL_Surface *surface, string filename)
{
	const char *c = filename.c_str();
...
bool CImage::SavePNG(SDL_Surface *surface, const char *filename)
{
	png_bytep  *pngRows;
	png_structp pngPtr;
	png_infop   pngInfo;
...
bool CImage::SavePNG(SDL_Surface *surface, string filename)
{
	const char *c = filename.c_str();
...
void CImage::VFlip(void *pixels, Uint16 width, Uint16 height, Uint32 bpp)
{
	Uint8 *buffer;
